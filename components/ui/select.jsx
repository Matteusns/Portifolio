...
const SelectTrigger = React.forwardRef(
  ({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex h-[38px] items-center justify-between rounded-md border border-white/10 bg-primary px-4 py-5 text-white/60 placeholder:text-white/10 focus:border-accent outline-none",
        className
      )}
      {...props}
    >
